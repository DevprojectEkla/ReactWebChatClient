...
const HOVER_EFFECT = (end_color, text_color = 'inherit') => {
    return `&:hover {color:${text_color};
...
const DEFAULT_AVATAR_HASH_NAME =
    '2f6ef1ab218b73b662d2ef359aba36ce8ca9086a6aca2f5e7748a8d0fed58aca';
